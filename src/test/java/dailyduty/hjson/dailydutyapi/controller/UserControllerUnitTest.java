...
import dailyduty.hjson.dailydutyapi.DummyEntity;
import dailyduty.hjson.dailydutyapi.config.MyFilterRegisterConfig;
import dailyduty.hjson.dailydutyapi.core.MyWithMockUser;
import dailyduty.hjson.dailydutyapi.core.advice.MyLogAdvice;
import dailyduty.hjson.dailydutyapi.core.advice.MyValidAdvice;
import dailyduty.hjson.dailydutyapi.model.user.User;
import dailyduty.hjson.dailydutyapi.service.UserService;
...
public class UserControllerUnitTest extends DummyEntity {
    ...
    //@WithMockUser(value = "ssar", password = "1234", roles = "USER") 이렇게 넣는다.
    @Test
